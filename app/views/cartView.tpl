            ...
            <table class="alt" id="cartTable">
                    ...
                    {foreach $cart as $c}
                        {strip}
                            <tr>
                                ...
                                <td>{number_format($c["prize"], 2, ',', ' ')} zł</td>
                                <td>{number_format($c["prize"] * $c["quantity"], 2, ',', ' ')} zł</td>
                                {$total = $total + ($c["prize"] * $c["quantity"])}
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="background-color: #f56a6a;"></td>
                        <td style="background-color: #f56a6a; color: black;">{number_format($total, 2, ',', ' ')} zł</td>
                    </tr>
                </tfoot>
            </table>
